...
public class BisqEnvironment extends StandardEnvironment {
    ...
    public BisqEnvironment(PropertySource commandLineProperties) {
        ...
        httpApiHost = getProperty(commandLineProperties, AppOptionKeys.HTTP_API_HOST, "127.0.0.1");
        httpApiPort = Integer.parseInt(getProperty(commandLineProperties, AppOptionKeys.HTTP_API_PORT, "8080"));
